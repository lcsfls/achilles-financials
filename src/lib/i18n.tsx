...
const EN: Record<string, string> = {
  ...
  "Fotos": "Photos",
  "Dieses Foto wirklich löschen?": "Delete this photo?",
  "Kreditbericht": "Loan report",
  "Kreditbericht · {name}": "Loan report · {name}",
  "Vorschau des Dokuments. Über „Drucken“ im Dialog „Als PDF sichern“ wählen.": "Preview of the document. Use Print, then choose “Save as PDF” in the dialog.",
  ...
  "Monat": "month",
  "1 Buchung": "1 booking",
  "Abschluss- und Vertriebskosten": "Acquisition and distribution costs",
  "Abschluss- und Vertriebskosten (€)": "Acquisition and distribution costs (€)",
  "Als PDF exportieren": "Export as PDF",
  "Aufgelaufene Zinsen": "Accrued interest",
  "Ausgabe": "Expense",
  "Einnahme": "Income",
  "Bei {rate}/Monat schuldenfrei in {months} Monaten": "Debt-free in {months} months at {rate}/month",
  "Beiträge insgesamt bisher (€)": "Contributions to date (€)",
  "Bescheid erfassen": "Add notice",
  "Betrag": "Amount",
  "Bisher erreicht": "Earned so far",
  "Bisher erreichte Rente (€/Monat)": "Pension earned so far (€/month)",
  "Buchung erfassen": "Add booking",
  "Danach offen": "Balance after",
  "Darlehen — aufgenommen": "Loan — borrowed",
  "Darlehen — verliehen": "Loan — lent out",
  "Datum des Bescheids": "Date of notice",
  "Die Buchung verändert den Kontostand des gewählten Kontos sofort. Nur bei manuell geführten Konten möglich.": "The booking changes the selected account's balance immediately. Manual accounts only.",
  "Die Posten ergeben {computed}, im Auszug steht {actual} — Differenz {diff}. Vermutlich ein Tippfehler oder ein Posten, den dieser Vertrag anders ausweist.": "The line items add up to {computed}, the statement says {actual} — a gap of {diff}. Likely a typo, or an item this contract reports differently.",
  "Die Rate deckt nicht einmal die Zinsen — die Schuld würde wachsen. Nötig wären mindestens {amount}/Monat.": "The rate does not even cover the interest — the debt would grow. At least {amount}/month is needed.",
  "Die Werte stehen auf der Renteninformation der Deutschen Rentenversicherung. Alle Felder außer dem Datum sind optional.": "The figures are printed on your annual notice from Deutsche Rentenversicherung. Every field except the date is optional.",
  "Diese Beträge sind monatliche Ansprüche, kein Guthaben — sie fließen bewusst nicht ins Gesamtvermögen ein. Man kann eine Rente nicht verkaufen; sie ersetzt später Einkommen, statt Kapital zu sein.": "These are monthly entitlements, not a balance — they are deliberately kept out of net worth. A pension cannot be sold; it replaces income later rather than being capital.",
  "Diese Posten stehen so auf deiner Jahresmitteilung. Trägst du sie ein, zeigt Achilles für das Jahr, wie viel Ertrag der Vertrag erwirtschaftet hat und wie viel davon in Kosten geflossen ist.": "These items are printed on your annual statement. Enter them and Achilles shows what the contract earned that year and how much of it went to costs.",
  "Diesen Bescheid wirklich löschen?": "Delete this notice?",
  "Drucken": "Print",
  "Eingezahlte Beiträge": "Contributions paid",
  "Empfänger / Beschreibung": "Payee / description",
  "Entgeltpunkte": "Pension points",
  "Erstellt mit Achilles Financials am {date}. Der Tilgungsplan ist eine Vorausberechnung, keine Forderungsaufstellung.": "Created with Achilles Financials on {date}. The amortisation schedule is a projection, not a statement of claim.",
  "Ertrag nach Kosten": "Gain after costs",
  "Erwerbsminderung": "Reduced earning capacity",
  "Erwirtschaftete Erträge": "Returns earned",
  "Erwirtschaftete Erträge — Zinsen, Überschüsse (€)": "Returns earned — interest, surplus (€)",
  "Fällig": "Due",
  "Fällig am": "Due on",
  "Für alles ohne Bankanbindung — Bargeld, Konten bei Banken ohne API, Sparbücher. Der Kontostand wird hier direkt gepflegt und von keinem Abruf überschrieben.": "For anything without a bank connection — cash, accounts at banks with no API, passbooks. The balance is kept here directly and no sync overwrites it.",
  "Geleistete Zahlungen": "Payments made",
  "Gesetzliche Rente": "Statutory pension",
  "Gezahlt insgesamt": "Paid in total",
  "Hochgerechnete Rente (€/Monat)": "Projected pension (€/month)",
  "Hochrechnung": "Projection",
  "Kategorie": "Category",
  "Konten von Hand": "Manual accounts",
  "Konto anlegen": "Create account",
  "Kontostand ändern": "Edit balance",
  "Kosten als positive Beträge eintragen — sie werden als Abzug gerechnet.": "Enter costs as positive amounts — they are counted as deductions.",
  "Kosten gesamt": "Total costs",
  "Laufzeit": "Term",
  "Letzte Rate": "Final instalment",
  "Monatliche Rate (€, optional)": "Monthly payment (€, optional)",
  "Neues Konto": "New account",
  "Noch kein Bescheid erfasst. Die Werte stehen auf deiner jährlichen Renteninformation der Deutschen Rentenversicherung.": "No notice recorded yet. The figures are on your annual notice from Deutsche Rentenversicherung.",
  "Noch keine Zahlungen erfasst.": "No payments recorded yet.",
  "Nr.": "No.",
  "Nur mit Rate lässt sich ein Tilgungsplan vorausberechnen.": "A schedule can only be projected if a rate is set.",
  "Offen gesamt": "Total outstanding",
  "Offenes Kapital": "Principal outstanding",
  "Rate": "Payment",
  "Rentenbescheid": "Pension award notice",
  "Renteninformation": "Pension information",
  "Renteninformation & Rentenbescheid": "Pension information & award notice",
  "Restschuld": "Balance",
  "Summe": "Total",
  "Tilgung": "Principal",
  "Tilgungsplan": "Amortisation schedule",
  "Tilgungsplan · {name}": "Amortisation schedule · {name}",
  "Ursprüngliche Summe": "Original amount",
  "Vereinbarte Rate": "Agreed payment",
  "Vertragsguthaben": "Contract balance",
  "Verwaltungskosten": "Administration costs",
  "Verwaltungskosten (€)": "Administration costs (€)",
  "Volle Erwerbsminderung (€/Monat)": "Full reduced earning capacity (€/month)",
  "Vorausberechnet ab heute auf {outstanding} Restschuld bei {rate} monatlich. Kein Kontoauszug — was tatsächlich gezahlt wurde, steht unter Zahlungen.": "Projected from today on {outstanding} outstanding at {rate} per month. Not a statement — what was actually paid is under Payments.",
  "Vorausberechnet ab heute bei {rate} monatlich — {months} Raten, {interest} Zinsen, letzte Rate {date}.": "Projected from today at {rate} per month — {months} instalments, {interest} interest, final instalment {date}.",
  "Vorheriges Vertragsguthaben": "Previous contract balance",
  "Vorheriges Vertragsguthaben (€)": "Previous contract balance (€)",
  "Weitere Angaben vom Auszug (optional)": "More from your statement (optional)",
  "Wert aus Entwicklung des Fondsportfolios": "Value from fund portfolio performance",
  "Wert aus Entwicklung des Fondsportfolios (€)": "Value from fund portfolio performance (€)",
  "Zinsen": "Interest",
  "Zinsen gesamt": "Total interest",
  "Zinssatz": "Interest rate",
  "Zuerst ein manuelles Konto anlegen": "Create a manual account first",
  "automatisch": "automatic",
  "bei gleichem Beitrag": "at the same contribution",
  "davon Zinsen": "of which interest",
  "davon vom Jahresbeitrag": "of the annual contribution",
  "laut Auszug seit Vertragsbeginn": "per statement, since inception",
  "ohne weitere Beiträge": "without further contributions",
  "volle Erwerbsminderung": "full reduced earning capacity",
  "z. B. Wochenmarkt": "e.g. farmers' market",
  "Über den Druckdialog als PDF sichern.": "Save as PDF via the print dialog.",
  "„{name}“ mit allen {n} Buchungen löschen?": "Delete “{name}” and all {n} bookings?",
